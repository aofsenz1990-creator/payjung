...
export type ProviderAdapter = {
  ...
  fetchCatalog?(
    ...
    opts: {
      /**
       * @deprecated ไม่ได้ใช้แล้ว — เอกสารของ OverTopup ไม่มีเรื่องระดับลูกค้า/VIP เลย
       * ราคาที่ได้กลับมาเป็นของบัญชีเราอยู่แล้ว ไม่ต้องบอกระดับ
       */
      vip?: boolean
      /**
      ...
      /**
       * เอาเฉพาะรหัสสินค้าเหล่านี้พอ (ปกติคือเกมที่ร้านเปิดขายอยู่จริง)
       * เจ้าที่ยิงทีละสินค้า (JCR) จะประหยัดมาก — จาก 200 กว่าสินค้าเหลือแค่สิบกว่าตัว
       * เจ้าที่ยิงครั้งเดียวได้ทั้งร้านอยู่แล้วจะไม่สนใจค่านี้ ฝั่งที่เรียกใช้กรองเองทีหลัง
       */
